...
- 📈 **ML Price Prediction** - The frontend Dashboard's **ML Forecast** at http://localhost:3000 includes a **time‑series forecasting endpoint** that predicts crypto prices for the next 6 hours
